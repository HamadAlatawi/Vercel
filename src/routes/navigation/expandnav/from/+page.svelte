<script>
    ...
    export let fromBar = false;
</script>

<div class="grid grid-cols-12 mb-12 -ml-24 -mt-8 z-20 absolute w-full" in:fly={{y:25, duration: 500, delay: 50}} out:fly={{y:25, duration: 500}} use:clickOutside on:outclick={() => (fromBar = false)}>
